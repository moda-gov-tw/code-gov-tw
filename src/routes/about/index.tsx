      ...
      <Section>
        <div class="flex flex-col gap-8 xl:flex-row-reverse xl:items-center">
          <div class="mt-8 flex flex-col gap-4">
            ...
            <p>{$localize`而國際上著名的公共程式跨國案例為 X-Road（https://x-road.global/），由愛沙尼亞、芬蘭和冰島政府共同營運。除了各國政府能夠自由使用功能以外，例如在補助申請和駕照換發等功能，因為公共程式的特性，各國將都可以公開檢視與提供建議，並一旦發現問題，即可立即提出修正並將反饋納入系統中，並且讓所有單位同步更新。`}</p>
