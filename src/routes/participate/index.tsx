      ...
      <Section>
        ...
        <div class="mt-8 flex flex-col gap-8">
          ...
          <Block title={$localize`透過 Pull Request 提出程式碼修改建議`}>
            <div>
              {$localize`Pull Request 是 GitHub 中的一種通知機制，允許專業協作者告訴其他人有一段代碼已經完成修改。目前各政府機關於 GitHub 上儲存的公共程式，提供不同程度的參與形式。因此若是您欲投入專業協作，包括進行代碼審查、討論和改進，請直接前往想參與的公共程式，查看是否開放 Pull Request。`}
            </div>
          </Block>
        </div>
      </Section>
